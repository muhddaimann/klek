...
import { PieChart, AlertCircle, RefreshCw } from "lucide-react-native";
...
export default function Budget() {
  ...
  const canAddRecord = isSetup;
  const budgetCtaLabel = isSetup ? "Update budget" : "Create budget";
            ...
            >
              ...
              >
                {filtered.length === 0 ? (
                  <EmptyState
                    Icon={AlertCircle}
                    title={isSetup ? "No results" : "No budget yet"}
                    subtitle={
                      isSetup
          ...
          <Button
            onPress={() =>
              router.push({
                ...
                params: { mode: isSetup ? "update" : "create" },
              })
            }
            variant="default"
            rounded="lg"
